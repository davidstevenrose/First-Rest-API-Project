package com.shamus.app.ws.ui.controller;
...
import com.shamus.app.ws.ui.model.request.UpdateUserDetailsRequestModel;
...
public class UserController {
	...
	public String getUsers(@RequestParam(value = "page", defaultValue = "1") int page,
		...
		return "get user was with page = " + page + " and limit of " + limit + " sort: " + sort;
	}
	...
	public UserRest updateUser(@PathVariable String userId, @Valid @RequestBody UpdateUserDetailsRequestModel userDetails) {
		UserRest retDetails = users.get(userId);
		retDetails.setFirstName(userDetails.getFirstName());
		retDetails.setLastName(userDetails.getLastName());
		users.put(userId,  retDetails);
		return retDetails;
	}
